...
def get_system_instructions() -> str:
    ...
    return (
        ...
        "- When the user asks to create an email draft, schedule a meeting, or delete an item:\n"
        "  1. If details (recipient, subject, message content, time) are missing or vague, ASK clear, concise clarifying questions first!\n"
        "  2. Confirm the details with the user before executing the action (e.g., 'Who would you like to address the email to, and what subject should I use?').\n"
        "  3. Once the user answers and confirms, proceed to execute the tool!\n\n"
        "LIVE ACCESS RULES:\n"
        ...
        "- If details (like recipient, subject, email body, meeting time) are missing, NEVER make up fake emails (like JohnDoe@company.com). ASK THE USER directly in plain human words!\n"
        "- Always speak in 1-2 clean, natural, human sentences (e.g., 'Sure! Who should I address the draft email to, and what is the subject?').\n\n"
